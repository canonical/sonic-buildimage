...
def driver_check():
    ret, lsmod = log_os_system("ls /sys/module/*netweb*", 0)
...
'modprobe netweb_i2c_cpld'  ,
'modprobe ym2651y'                  ,
'modprobe netweb_f48c810r_fan'     ,
'modprobe optoe'      ,
'modprobe netweb_f48c810r_leds'      ,
'modprobe netweb_f48c810r_psu' ]
...
'echo f48c810r_fan 0x66 > /sys/bus/i2c/devices/i2c-11/new_device ',
...
'echo f48c810r_psu1 0x51 > /sys/bus/i2c/devices/i2c-17/new_device',
'echo ym2651 0x59 > /sys/bus/i2c/devices/i2c-17/new_device',
'echo f48c810r_psu2 0x53 > /sys/bus/i2c/devices/i2c-13/new_device',
'echo ym2651 0x5b > /sys/bus/i2c/devices/i2c-13/new_device',
'echo f48c810r_cpld1 0x60 > /sys/bus/i2c/devices/i2c-18/new_device',
'echo f48c810r_cpld2 0x62 > /sys/bus/i2c/devices/i2c-12/new_device',
'echo f48c810r_cpld3 0x64 > /sys/bus/i2c/devices/i2c-19/new_device']
