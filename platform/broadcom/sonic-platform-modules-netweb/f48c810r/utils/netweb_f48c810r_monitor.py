#!/usr/bin/env python
#
# Copyright (C) 2017 Netweb Technology Corporation
#
...
# HISTORY:
#    mm/dd/yyyy (A.D.)
#    3/23/2018: Roy Lee modify for f48c810r
...
try:
    ...
    from f48c810r.fanutil import FanUtil
    from f48c810r.thermalutil import ThermalUtil
except ImportError as e:
    raise ImportError('%s - required module not found' % str(e))

# Deafults
VERSION = '1.0'
FUNCTION_NAME = '/usr/local/bin/netweb_f48c810r_monitor'
