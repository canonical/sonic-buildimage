 ...
 *
 * Copyright (C) 2018 Netweb Technology Corporation.
 * Roy Lee <roy_lee@netweb.com.tw>
 *
...
static const struct i2c_device_id pmbus_id[] = {
    { "netweb_ym2651", YM2651 },
    { "netweb_ym2401", YM2401 },
    { "netweb_ym2851", YM2851 },
    {}
};
...
MODULE_AUTHOR("Roy Lee<roy_lee@netweb.com.tw>");
MODULE_DESCRIPTION("Netweb PMBus driver for 3Y Power YM-2651Y.");
MODULE_LICENSE("GPL");
