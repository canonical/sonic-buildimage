...
load_kernel_drivers() {
    ...
    sudo insmod /lib/modules/7.0.0-1002-sonic/kernel/extra/nokia_7215_ixs_a1_cpld.ko
    sudo insmod /lib/modules/7.0.0-1002-sonic/kernel/extra/cn9130_cpu_thermal_sensor.ko
}
