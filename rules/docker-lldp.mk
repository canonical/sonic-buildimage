...
# NOTE: LLDPD_DBG (lldpd-dbgsym) is NOT included — Ubuntu dbgsym packages
# live at ddebs.ubuntu.com (separate archive), not the main pool.
$(DOCKER_LLDP)_DBG_DEPENDS += $(LIBSWSSCOMMON_DBG)
